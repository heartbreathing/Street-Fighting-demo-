...
function rectangularCollision({rectangle1, rectangle2}) {
    return (
        rectangle1.attackBox.position.x + rectangle1.attackBox.width >= enemy.position.x && rectangle1.position.x <= enemy.position.x + enemy.width && rectangle1.attackBox.position.y + rectangle1.attackBox.height >= enemy.attackBox.position.y && rectangle1.attackBox.position.y <= enemy.position.y + enemy.height
    )
}
