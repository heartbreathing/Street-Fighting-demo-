...
class Sprite {
    ...
    draw () {
        ...
        context.fillRect(this.position.x, this.position.y, this, this.height);
...
function animate() {
    ...
    if (player.attackBox.position.x + player.attackBox.width >= enemy.position.x && player.position.x <= enemy.position.x + enemy.width) {
