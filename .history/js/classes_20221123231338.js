...
class Fighter extends Sprite {
    ...
    flipSprite(sprite) {
        this.image = new Image();
            this.image.src = sprites[sprite].image = new Image();.imageSrc;
                        sprites[sprite].image.src = sprites[sprite].imageSrc;.image.scale(-1, 1);
                        sprites[sprite].image.scale(-1, 1);.image.translate(-            sprites[sprite].image.translate(-sprites[sprite].img.width, 0);.img.width, 0);
