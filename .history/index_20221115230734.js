...
//Create a class to define the properties and methods 
class Sprite {

    //The position and the velocity are arrays which their values been defined by two directions and this peak to the calling objec
